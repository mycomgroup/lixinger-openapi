...
```bash
python3 skills/lixinger-data-query/scripts/query_tool.py --suffix "cn.company.fundamental.non_financial" --params '{"date": "2024-12-31", "stockCodes": ["600519"]}' --columns "stockCode,pe_ttm,pb,marketValue"
```
