...
```bash
python3 skills/lixinger-data-query/scripts/query_tool.py --suffix "cn.company.block-deal" --params '{"stockCode": "600519"}' --columns "date,price,volume,premium" --limit 20
```
