# API 规范: hk/index/valuation (港股指数估值数据)

获取港股指数估值数据

## 接口地址
- **URL 后缀**: `hk/index/valuation`
- **支持格式**: `hk.index.valuation`
...
## 调用示例
```bash
python skills/lixinger-data-query/scripts/query_tool.py --suffix "hk/index/valuation" --params '{"stockCodes": ["HSI"], "date": "2024-12-31"}'
```
