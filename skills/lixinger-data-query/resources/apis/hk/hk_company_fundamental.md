# API 规范: hk/company/fundamental (港股基本面数据)

获取港股基本面数据

## 接口地址
- **URL 后缀**: `hk/company/fundamental`
- **支持格式**: `hk.company.fundamental`
...
## 调用示例
```bash
python skills/lixinger-data-query/scripts/query_tool.py --suffix "hk/company/fundamental" --params '{"stockCodes": ["00700"], "date": "2024-12-31"}'
```
