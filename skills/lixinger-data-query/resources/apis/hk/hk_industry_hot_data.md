# API 规范: hk/industry/hot-data (港股行业热度数据)

获取港股行业热度数据

## 接口地址
- **URL 后缀**: `hk/industry/hot-data`
- **支持格式**: `hk.industry.hot-data`
...
## 调用示例
```bash
python skills/lixinger-data-query/scripts/query_tool.py --suffix "hk/industry/hot-data" --params '{"stockCodes": ["HK_IND_001"], "date": "2024-12-31"}'
```
