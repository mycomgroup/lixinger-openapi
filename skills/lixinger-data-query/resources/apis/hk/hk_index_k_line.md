# API 规范: hk/index/k-line (港股指数K线数据)

获取港股指数K线数据

## 接口地址
- **URL 后缀**: `hk/index/k-line`
- **支持格式**: `hk.index.k-line`
...
## 调用示例
```bash
python skills/lixinger-data-query/scripts/query_tool.py --suffix "hk/index/k-line" --params '{"stockCode": "HSI", "startDate": "2024-01-01", "endDate": "2024-12-31"}'
```
