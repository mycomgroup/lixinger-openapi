# API 规范: hk/index/constituents (港股指数成分股)

获取港股指数成分股数据

## 接口地址
- **URL 后缀**: `hk/index/constituents`
- **支持格式**: `hk.index.constituents`
...
## 调用示例
```bash
python skills/lixinger-data-query/scripts/query_tool.py --suffix "hk/index/constituents" --params '{"stockCodes": ["HSI"], "date": "2024-12-31"}'
```
