# API 规范: hk/industry/valuation (港股行业估值数据)

获取港股行业估值数据

## 接口地址
- **URL 后缀**: `hk/industry/valuation`
- **支持格式**: `hk.industry.valuation`
...
## 调用示例
```bash
python skills/lixinger-data-query/scripts/query_tool.py --suffix "hk/industry/valuation" --params '{"stockCodes": ["HK_IND_001"], "date": "2024-12-31"}'
```
