# API 规范: hk/industry/financial (港股行业财务数据)

获取港股行业财务数据

## 接口地址
- **URL 后缀**: `hk/industry/financial`
- **支持格式**: `hk.industry.financial`
...
## 调用示例
```bash
python skills/lixinger-data-query/scripts/query_tool.py --suffix "hk/industry/financial" --params '{"stockCodes": ["HK_IND_001"], "date": "2024-12-31"}'
```
