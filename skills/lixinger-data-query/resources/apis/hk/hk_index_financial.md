# API 规范: hk/index/financial (港股指数财务数据)

获取港股指数财务数据

## 接口地址
- **URL 后缀**: `hk/index/financial`
- **支持格式**: `hk.index.financial`
...
## 调用示例
```bash
python skills/lixinger-data-query/scripts/query_tool.py --suffix "hk/index/financial" --params '{"stockCodes": ["HSI"], "date": "2024-12-31"}'
```
