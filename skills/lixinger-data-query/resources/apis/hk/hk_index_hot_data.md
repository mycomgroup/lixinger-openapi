# API 规范: hk/index/hot-data (港股指数热度数据)

获取港股指数热度数据

## 接口地址
- **URL 后缀**: `hk/index/hot-data`
- **支持格式**: `hk.index.hot-data`
...
## 调用示例
```bash
python skills/lixinger-data-query/scripts/query_tool.py --suffix "hk/index/hot-data" --params '{"stockCodes": ["HSI"], "date": "2024-12-31"}'
```
