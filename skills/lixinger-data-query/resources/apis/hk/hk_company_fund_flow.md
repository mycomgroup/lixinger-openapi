# API 规范: hk/company/fund-flow (港股资金流向)

获取港股资金流向数据

## 接口地址
- **URL 后缀**: `hk/company/fund-flow`
- **支持格式**: `hk.company.fund-flow`
...
## 调用示例
```bash
python skills/lixinger-data-query/scripts/query_tool.py --suffix "hk/company/fund-flow" --params '{"stockCodes": ["00700"], "date": "2024-12-31"}'
```
