# API 规范: hk/company/shareholders (港股股东)

获取港股股东数据

## 接口地址
- **URL 后缀**: `hk/company/shareholders`
- **支持格式**: `hk.company.shareholders`
...
## 调用示例
```bash
python skills/lixinger-data-query/scripts/query_tool.py --suffix "hk/company/shareholders" --params '{"stockCodes": ["00700"], "date": "2024-12-31"}'
```
