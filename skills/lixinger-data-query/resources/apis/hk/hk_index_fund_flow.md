# API 规范: hk/index/fund-flow (港股指数资金流向)

获取港股指数资金流向数据

## 接口地址
- **URL 后缀**: `hk/index/fund-flow`
- **支持格式**: `hk.index.fund-flow`
...
## 调用示例
```bash
python skills/lixinger-data-query/scripts/query_tool.py --suffix "hk/index/fund-flow" --params '{"stockCodes": ["HSI"], "date": "2024-12-31"}'
```
