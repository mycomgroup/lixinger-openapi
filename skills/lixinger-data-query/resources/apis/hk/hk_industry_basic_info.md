# API 规范: hk/industry/basic-info (港股行业基本信息)

获取港股行业基本信息数据

## 接口地址
- **URL 后缀**: `hk/industry/basic-info`
- **支持格式**: `hk.industry.basic-info`
...
## 调用示例
```bash
python skills/lixinger-data-query/scripts/query_tool.py --suffix "hk/industry/basic-info" --params '{"stockCodes": ["HK_IND_001"]}'
```
