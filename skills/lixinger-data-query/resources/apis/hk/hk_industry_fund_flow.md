# API 规范: hk/industry/fund-flow (港股行业资金流向)

获取港股行业资金流向数据

## 接口地址
- **URL 后缀**: `hk/industry/fund-flow`
- **支持格式**: `hk.industry.fund-flow`
...
## 调用示例
```bash
python skills/lixinger-data-query/scripts/query_tool.py --suffix "hk/industry/fund-flow" --params '{"stockCodes": ["HK_IND_001"], "date": "2024-12-31"}'
```
