# API 规范: macro/reserve-requirement-ratio (存款准备金率)

获取存款准备金率数据

## 接口地址
- **URL 后缀**: `macro/reserve-requirement-ratio`
- **支持格式**: `macro.reserve-requirement-ratio`
...
## 调用示例
```bash
python skills/lixinger-data-query/scripts/query_tool.py --suffix "macro/reserve-requirement-ratio" --params '{"startDate": "2024-01-01", "endDate": "2024-12-31"}'
```
