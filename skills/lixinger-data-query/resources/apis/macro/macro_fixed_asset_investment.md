# API 规范: macro/fixed-asset-investment (全社会固定资产投资)

获取全社会固定资产投资数据

## 接口地址
- **URL 后缀**: `macro/fixed-asset-investment`
- **支持格式**: `macro.fixed-asset-investment`
...
## 调用示例
```bash
python skills/lixinger-data-query/scripts/query_tool.py --suffix "macro/fixed-asset-investment" --params '{"startDate": "2024-01-01", "endDate": "2024-12-31"}'
```
