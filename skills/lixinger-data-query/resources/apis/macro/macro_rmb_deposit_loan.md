# API 规范: macro/rmb-deposit-loan (人民币存贷款)

获取人民币存贷款数据

## 接口地址
- **URL 后缀**: `macro/rmb-deposit-loan`
- **支持格式**: `macro.rmb-deposit-loan`
...
## 调用示例
```bash
python skills/lixinger-data-query/scripts/query_tool.py --suffix "macro/rmb-deposit-loan" --params '{"startDate": "2024-01-01", "endDate": "2024-12-31"}'
```
