# API 规范: macro/government-bond (国债)

获取国债数据

## 接口地址
- **URL 后缀**: `macro/government-bond`
- **支持格式**: `macro.government-bond`
...
## 调用示例
```bash
python skills/lixinger-data-query/scripts/query_tool.py --suffix "macro/government-bond" --params '{"startDate": "2024-01-01", "endDate": "2024-12-31"}'
```
