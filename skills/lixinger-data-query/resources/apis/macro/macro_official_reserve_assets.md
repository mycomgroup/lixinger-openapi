# API 规范: macro/official-reserve-assets (官方储备资产)

获取官方储备资产数据

## 接口地址
- **URL 后缀**: `macro/official-reserve-assets`
- **支持格式**: `macro.official-reserve-assets`
...
## 调用示例
```bash
python skills/lixinger-data-query/scripts/query_tool.py --suffix "macro/official-reserve-assets" --params '{"startDate": "2024-01-01", "endDate": "2024-12-31"}'
```
