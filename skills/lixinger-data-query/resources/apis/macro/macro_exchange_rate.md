# API 规范: macro/exchange-rate (汇率)

获取汇率数据

## 接口地址
- **URL 后缀**: `macro/exchange-rate`
- **支持格式**: `macro.exchange-rate`
...
## 调用示例
```bash
python skills/lixinger-data-query/scripts/query_tool.py --suffix "macro/exchange-rate" --params '{"startDate": "2024-01-01", "endDate": "2024-12-31"}'
```
