# API 规范: macro/stamp-duty (印花税)

获取印花税数据

## 接口地址
- **URL 后缀**: `macro/stamp-duty`
- **支持格式**: `macro.stamp-duty`
...
## 调用示例
```bash
python skills/lixinger-data-query/scripts/query_tool.py --suffix "macro/stamp-duty" --params '{"startDate": "2024-01-01", "endDate": "2024-12-31"}'
```
