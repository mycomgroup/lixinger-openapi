# API 规范: macro/commodities (大宗商品)

获取大宗商品数据

## 接口地址
- **URL 后缀**: `macro/commodities`
- **支持格式**: `macro.commodities`
...
## 调用示例
```bash
python skills/lixinger-data-query/scripts/query_tool.py --suffix "macro/commodities" --params '{"startDate": "2024-01-01", "endDate": "2024-12-31"}'
```
