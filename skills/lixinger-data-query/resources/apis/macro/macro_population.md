# API 规范: macro/population (人口)

获取人口数据

## 接口地址
- **URL 后缀**: `macro/population`
- **支持格式**: `macro.population`
...
## 调用示例
```bash
python skills/lixinger-data-query/scripts/query_tool.py --suffix "macro/population" --params '{"startDate": "2024-01-01", "endDate": "2024-12-31"}'
```
