# API 规范: macro/dollar-index (美元指数)

获取美元指数数据

## 接口地址
- **URL 后缀**: `macro/dollar-index`
- **支持格式**: `macro.dollar-index`
...
## 调用示例
```bash
python skills/lixinger-data-query/scripts/query_tool.py --suffix "macro/dollar-index" --params '{"startDate": "2024-01-01", "endDate": "2024-12-31"}'
```
