# API 规范: macro/unemployment-rate (失业率)

获取失业率数据

## 接口地址
- **URL 后缀**: `macro/unemployment-rate`
- **支持格式**: `macro.unemployment-rate`
...
## 调用示例
```bash
python skills/lixinger-data-query/scripts/query_tool.py --suffix "macro/unemployment-rate" --params '{"startDate": "2024-01-01", "endDate": "2024-12-31"}'
```
