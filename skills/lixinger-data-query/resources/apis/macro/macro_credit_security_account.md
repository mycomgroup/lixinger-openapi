# API 规范: macro/credit-security-account (信用证券账户)

获取信用证券账户数据

## 接口地址
- **URL 后缀**: `macro/credit-security-account`
- **支持格式**: `macro.credit-security-account`
...
## 调用示例
```bash
python skills/lixinger-data-query/scripts/query_tool.py --suffix "macro/credit-security-account" --params '{"startDate": "2024-01-01", "endDate": "2024-12-31"}'
```
