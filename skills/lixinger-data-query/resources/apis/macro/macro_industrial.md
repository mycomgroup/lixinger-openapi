# API 规范: macro/industrial (工业)

获取工业数据

## 接口地址
- **URL 后缀**: `macro/industrial`
- **支持格式**: `macro.industrial`
...
## 调用示例
```bash
python skills/lixinger-data-query/scripts/query_tool.py --suffix "macro/industrial" --params '{"startDate": "2024-01-01", "endDate": "2024-12-31"}'
```
