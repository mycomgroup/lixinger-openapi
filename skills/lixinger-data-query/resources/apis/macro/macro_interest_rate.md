# API 规范: macro/interest-rate (利率)

获取利率数据

## 接口地址
- **URL 后缀**: `macro/interest-rate`
- **支持格式**: `macro.interest-rate`
...
## 调用示例
```bash
python skills/lixinger-data-query/scripts/query_tool.py --suffix "macro/interest-rate" --params '{"startDate": "2024-01-01", "endDate": "2024-12-31"}'
```
