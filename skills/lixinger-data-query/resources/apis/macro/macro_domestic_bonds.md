# API 规范: macro/domestic-bonds (国内各类债券)

获取国内各类债券数据

## 接口地址
- **URL 后缀**: `macro/domestic-bonds`
- **支持格式**: `macro.domestic-bonds`
...
## 调用示例
```bash
python skills/lixinger-data-query/scripts/query_tool.py --suffix "macro/domestic-bonds" --params '{"startDate": "2024-01-01", "endDate": "2024-12-31"}'
```
