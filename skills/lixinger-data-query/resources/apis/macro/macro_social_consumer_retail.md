# API 规范: macro/social-consumer-retail (社会消费品零售)

获取社会消费品零售数据

## 接口地址
- **URL 后缀**: `macro/social-consumer-retail`
- **支持格式**: `macro.social-consumer-retail`
...
## 调用示例
```bash
python skills/lixinger-data-query/scripts/query_tool.py --suffix "macro/social-consumer-retail" --params '{"startDate": "2024-01-01", "endDate": "2024-12-31"}'
```
