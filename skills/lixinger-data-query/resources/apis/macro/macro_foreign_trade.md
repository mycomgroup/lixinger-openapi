# API 规范: macro/foreign-trade (对外贸易)

获取对外贸易数据

## 接口地址
- **URL 后缀**: `macro/foreign-trade`
- **支持格式**: `macro.foreign-trade`
...
## 调用示例
```bash
python skills/lixinger-data-query/scripts/query_tool.py --suffix "macro/foreign-trade" --params '{"startDate": "2024-01-01", "endDate": "2024-12-31"}'
```
