# API 规范: macro/rmb-index (人民币指数)

获取人民币指数数据

## 接口地址
- **URL 后缀**: `macro/rmb-index`
- **支持格式**: `macro.rmb-index`
...
## 调用示例
```bash
python skills/lixinger-data-query/scripts/query_tool.py --suffix "macro/rmb-index" --params '{"startDate": "2024-01-01", "endDate": "2024-12-31"}'
```
