# API 规范: macro/social-financing (社会融资)

获取社会融资数据

## 接口地址
- **URL 后缀**: `macro/social-financing`
- **支持格式**: `macro.social-financing`
...
## 调用示例
```bash
python skills/lixinger-data-query/scripts/query_tool.py --suffix "macro/social-financing" --params '{"startDate": "2024-01-01", "endDate": "2024-12-31"}'
```
