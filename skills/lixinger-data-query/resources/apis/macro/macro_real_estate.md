# API 规范: macro/real-estate (房地产)

获取房地产数据

## 接口地址
- **URL 后缀**: `macro/real-estate`
- **支持格式**: `macro.real-estate`
...
## 调用示例
```bash
python skills/lixinger-data-query/scripts/query_tool.py --suffix "macro/real-estate" --params '{"startDate": "2024-01-01", "endDate": "2024-12-31"}'
```
