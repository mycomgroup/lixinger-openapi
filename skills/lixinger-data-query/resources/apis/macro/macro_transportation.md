# API 规范: macro/transportation (交通运输)

获取交通运输数据

## 接口地址
- **URL 后缀**: `macro/transportation`
- **支持格式**: `macro.transportation`
...
## 调用示例
```bash
python skills/lixinger-data-query/scripts/query_tool.py --suffix "macro/transportation" --params '{"startDate": "2024-01-01", "endDate": "2024-12-31"}'
```
