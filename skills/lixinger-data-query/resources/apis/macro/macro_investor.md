# API 规范: macro/investor (投资者)

获取投资者数据

## 接口地址
- **URL 后缀**: `macro/investor`
- **支持格式**: `macro.investor`
...
## 调用示例
```bash
python skills/lixinger-data-query/scripts/query_tool.py --suffix "macro/investor" --params '{"startDate": "2024-01-01", "endDate": "2024-12-31"}'
```
