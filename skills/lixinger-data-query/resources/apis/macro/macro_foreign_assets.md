# API 规范: macro/foreign-assets (国外资产)

获取国外资产数据

## 接口地址
- **URL 后缀**: `macro/foreign-assets`
- **支持格式**: `macro.foreign-assets`
...
## 调用示例
```bash
python skills/lixinger-data-query/scripts/query_tool.py --suffix "macro/foreign-assets" --params '{"startDate": "2024-01-01", "endDate": "2024-12-31"}'
```
