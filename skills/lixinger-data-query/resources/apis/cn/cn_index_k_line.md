# API 规范: cn/index/k-line (指数K线数据)

获取指数K线数据

## 接口地址
- **URL 后缀**: `cn/index/k-line`
- **支持格式**: `cn.index.k-line`
...
## 调用示例
```bash
python skills/lixinger-data-query/scripts/query_tool.py --suffix "cn/index/k-line" --params '{"stockCode": "000300", "startDate": "2024-01-01", "endDate": "2024-12-31"}'
```
