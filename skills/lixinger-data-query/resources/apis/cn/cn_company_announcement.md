# API 规范: cn/company/announcement (公告)

获取公告数据

## 接口地址
- **URL 后缀**: `cn/company/announcement`
- **支持格式**: `cn.company.announcement`
...
## 调用示例
```bash
python skills/lixinger-data-query/scripts/query_tool.py --suffix "cn/company/announcement" --params '{"stockCodes": ["600519"], "startDate": "2024-01-01", "endDate": "2024-12-31"}'
```
