...
## 调用示例
```bash
python skills/lixinger-data-query/scripts/query_tool.py --suffix "cn/index/fundamental" --params '{"date": "2024-12-31", "startDate": "2020-01-01", "stockCodes": ["600519"], "endDate": "2024-12-31", "metricsList": ["pe_ttm"]}'
```
