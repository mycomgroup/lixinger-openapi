# API 规范: cn/company/hot-data (热度数据)

获取热度数据

## 接口地址
- **URL 后缀**: `cn/company/hot-data`
- **支持格式**: `cn.company.hot-data`
...
## 调用示例
```bash
python skills/lixinger-data-query/scripts/query_tool.py --suffix "cn/company/hot-data" --params '{"stockCodes": ["600519"], "date": "2024-12-31"}'
```
