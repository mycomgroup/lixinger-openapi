# API 规范: cn/fund/rating (基金评级)

获取基金评级数据

## 接口地址
- **URL 后缀**: `cn/fund/rating`
- **支持格式**: `cn.fund.rating`
...
## 调用示例
```bash
python skills/lixinger-data-query/scripts/query_tool.py --suffix "cn/fund/rating" --params '{"stockCodes": ["501018"], "date": "2024-12-31"}'
```
