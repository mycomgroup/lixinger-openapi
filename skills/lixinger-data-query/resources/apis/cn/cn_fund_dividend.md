# API 规范: cn/fund/dividend (基金分红)

获取基金分红数据

## 接口地址
- **URL 后缀**: `cn/fund/dividend`
- **支持格式**: `cn.fund.dividend`
...
## 调用示例
```bash
python skills/lixinger-data-query/scripts/query_tool.py --suffix "cn/fund/dividend" --params '{"stockCodes": ["501018"], "startDate": "2024-01-01", "endDate": "2024-12-31"}'
```
