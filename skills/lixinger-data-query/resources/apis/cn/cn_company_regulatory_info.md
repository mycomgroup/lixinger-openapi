# API 规范: cn/company/regulatory-info (监管信息)

获取监管信息数据

## 接口地址
- **URL 后缀**: `cn/company/regulatory-info`
- **支持格式**: `cn.company.regulatory-info`
...
## 调用示例
```bash
python skills/lixinger-data-query/scripts/query_tool.py --suffix "cn/company/regulatory-info" --params '{"stockCodes": ["600519"], "startDate": "2024-01-01", "endDate": "2024-12-31"}'
```
