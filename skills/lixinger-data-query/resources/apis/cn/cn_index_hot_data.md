# API 规范: cn/index/hot-data (指数热度数据)

获取指数热度数据

## 接口地址
- **URL 后缀**: `cn/index/hot-data`
- **支持格式**: `cn.index.hot-data`
...
## 调用示例
```bash
python skills/lixinger-data-query/scripts/query_tool.py --suffix "cn/index/hot-data" --params '{"stockCodes": ["000300"], "date": "2024-12-31"}'
```
