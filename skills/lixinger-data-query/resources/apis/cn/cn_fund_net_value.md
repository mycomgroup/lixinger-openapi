# API 规范: cn/fund/net-value (基金净值)

获取基金净值数据

## 接口地址
- **URL 后缀**: `cn/fund/net-value`
- **支持格式**: `cn.fund.net-value`
...
## 调用示例
```bash
python skills/lixinger-data-query/scripts/query_tool.py --suffix "cn/fund/net-value" --params '{"stockCodes": ["501018"], "startDate": "2024-01-01", "endDate": "2024-12-31"}'
```
