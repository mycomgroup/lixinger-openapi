# API 规范: cn/company/related-index (股票所属指数)

获取股票所属指数数据

## 接口地址
- **URL 后缀**: `cn/company/related-index`
- **支持格式**: `cn.company.related-index`
...
## 调用示例
```bash
python skills/lixinger-data-query/scripts/query_tool.py --suffix "cn/company/related-index" --params '{"stockCodes": ["600519"]}'
```
