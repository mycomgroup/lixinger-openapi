# API 规范: cn/index/financial (指数财务数据)

获取指数财务数据

## 接口地址
- **URL 后缀**: `cn/index/financial`
- **支持格式**: `cn.index.financial`
...
## 调用示例
```bash
python skills/lixinger-data-query/scripts/query_tool.py --suffix "cn/index/financial" --params '{"stockCodes": ["000300"], "date": "2024-12-31"}'
```
