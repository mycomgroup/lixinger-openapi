# API 规范: cn/company/client-supplier (客户及供应商)

获取客户及供应商数据

## 接口地址
- **URL 后缀**: `cn/company/client-supplier`
- **支持格式**: `cn.company.client-supplier`
...
## 调用示例
```bash
python skills/lixinger-data-query/scripts/query_tool.py --suffix "cn/company/client-supplier" --params '{"stockCodes": ["600519"], "date": "2024-12-31"}'
```
