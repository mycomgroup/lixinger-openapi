# API 规范: cn/fund/hot-data (基金热度数据)

获取基金热度数据

## 接口地址
- **URL 后缀**: `cn/fund/hot-data`
- **支持格式**: `cn.fund.hot-data`
...
## 调用示例
```bash
python skills/lixinger-data-query/scripts/query_tool.py --suffix "cn/fund/hot-data" --params '{"stockCodes": ["501018"], "date": "2024-12-31"}'
```
