# API 规范: cn/industry/valuation (行业估值数据)

获取行业估值数据

## 接口地址
- **URL 后缀**: `cn/industry/valuation`
- **支持格式**: `cn.industry.valuation`
...
## 调用示例
```bash
python skills/lixinger-data-query/scripts/query_tool.py --suffix "cn/industry/valuation" --params '{"stockCodes": ["801780"], "date": "2024-12-31"}'
```
