# API 规范: cn/industry/financial (行业财务数据)

获取行业财务数据

## 接口地址
- **URL 后缀**: `cn/industry/financial`
- **支持格式**: `cn.industry.financial`
...
## 调用示例
```bash
python skills/lixinger-data-query/scripts/query_tool.py --suffix "cn/industry/financial" --params '{"stockCodes": ["801780"], "date": "2024-12-31"}'
```
