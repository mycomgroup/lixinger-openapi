# API 规范: cn/fund/holdings (基金持仓)

获取基金持仓数据

## 接口地址
- **URL 后缀**: `cn/fund/holdings`
- **支持格式**: `cn.fund.holdings`
...
## 调用示例
```bash
python skills/lixinger-data-query/scripts/query_tool.py --suffix "cn/fund/holdings" --params '{"stockCodes": ["501018"], "date": "2024-12-31"}'
```
