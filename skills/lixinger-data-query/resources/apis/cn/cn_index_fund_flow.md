# API 规范: cn/index/fund-flow (指数资金流向)

获取指数资金流向数据

## 接口地址
- **URL 后缀**: `cn/index/fund-flow`
- **支持格式**: `cn.index.fund-flow`
...
## 调用示例
```bash
python skills/lixinger-data-query/scripts/query_tool.py --suffix "cn/index/fund-flow" --params '{"stockCodes": ["000300"], "date": "2024-12-31"}'
```
