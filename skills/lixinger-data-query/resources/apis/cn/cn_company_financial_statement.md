# API 规范: cn/company/financial-statement (财务报表)

获取财务报表数据

## 接口地址
- **URL 后缀**: `cn/company/financial-statement`
- **支持格式**: `cn.company.financial-statement`
...
## 调用示例
```bash
python skills/lixinger-data-query/scripts/query_tool.py --suffix "cn/company/financial-statement" --params '{"stockCodes": ["600519"], "date": "2024-12-31"}'
```
