# API 规范: us/index/fund-flow (美股指数资金流向)

获取美股指数资金流向数据

## 接口地址
- **URL 后缀**: `us/index/fund-flow`
- **支持格式**: `us.index.fund-flow`
...
## 调用示例
```bash
python skills/lixinger-data-query/scripts/query_tool.py --suffix "us/index/fund-flow" --params '{"stockCodes": ["SPX"], "date": "2024-12-31"}'
```
