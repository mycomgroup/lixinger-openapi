# API 规范: us/index/hot-data (美股指数热度数据)

获取美股指数热度数据

## 接口地址
- **URL 后缀**: `us/index/hot-data`
- **支持格式**: `us.index.hot-data`
...
## 调用示例
```bash
python skills/lixinger-data-query/scripts/query_tool.py --suffix "us/index/hot-data" --params '{"stockCodes": ["SPX"], "date": "2024-12-31"}'
```
